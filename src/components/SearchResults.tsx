      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
            ...
            <section>
              ...
              <div className="space-y-6">
                {searchResults.recommendedTools.map((tool, index) => (
                  <div key={index} className="bg-gray-800/50 border border-gray-700/50 rounded-xl p-6 hover:border-green-500/30 transition-all duration-200">
          ...
          <div className="space-y-8">
            {/* Roadmap */}
            <div className="bg-gray-800/30 border border-green-700/30 rounded-xl p-6">
              ...
              <div className="space-y-4">
                {searchResults.roadmap.map((step, index) => (
                  <div key={index} className="flex items-start">
                    <div className="flex-shrink-0 w-8 h-8 bg-green-600 text-white rounded-full flex items-center justify-center text-sm font-bold mr-4 mt-1">
                      {index + 1}
                    </div>
                    <div>
